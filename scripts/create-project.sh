...
EOF
    ...
    # 🧩 ${PROJECT_NAME}.java
    create_java_file "$SRC_DIR/${PROJECT_NAME}.java" "$PROJECT_NAME" "$(cat <<EOF
...
EOF
    ...
    create_java_file "$SRC_DIR/${PROJECT_NAME}DataSource.java" "${PROJECT_NAME}DataSource" "$(cat <<EOF
...
EOF
    ...
    create_java_file "$SRC_DIR/${PROJECT_NAME}Screen.java" "${PROJECT_NAME}Screen" "$(cat <<EOF
...
EOF
    ...
    # 🧩 Navigation.java
    create_java_file "$SRC_DIR/Navigation.java" "Navigation" "$(cat <<EOF
import org.openqa.selenium.By;
import org.openqa.selenium.WebDriver;
